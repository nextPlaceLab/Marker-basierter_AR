...
namespace UtyMap.Unity
{
    ...
    public class BoundingBox
    {
        ...
        public GeoCoordinate[] ToArray()
        {
            GeoCoordinate[] bbox = new GeoCoordinate[4];
            bbox[0] = this.TopLeft();
            bbox[1] = this.TopRight();
            bbox[2] = this.BottomRight();
            bbox[3] = this.BottomLeft();
            return bbox;
        }
        ...
        {
            return new GeoCoordinate(MinPoint.Latitude, MinPoint.Longitude + Width());
        }

        public GeoCoordinate BottomLeft()
        {
            return new GeoCoordinate(MinPoint.Latitude + Height(), MinPoint.Longitude);
        }
