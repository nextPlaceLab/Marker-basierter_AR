namespace nextPlace.ARVideoPlayer
{
    ...
    public abstract class WebCamera : MonoBehaviour
    {
        ...
        {
            get => (webCamDevice != null) ? webCamDevice.Value.name : null;
            set
            {
                // quick test
                if (value == DeviceName)
                ...
                if (-1 != cameraIndex)
                {
                    ...
                    //var res = webCamDevice.Value.availableResolutions;
                    //if (res != null)
                    //{
                    //    var resStr = "";
                    ...
                    //    }
                    //    MainScript.DisplayInfo(string.Format("Res = {0}", resStr));
                    //}

                    //webCamTexture = new WebCamTexture(webCamDevice.Value.name, (int)(Camera.main.aspect * 2160), 2160, 30);
